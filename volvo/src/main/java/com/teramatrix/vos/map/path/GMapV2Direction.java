...
/**
 * I call Google api for getting a xml to get directions between two points. I have a class named Getdirections.java 
 * in which I create an instance of GMapV2Direction.java class. 
 * In GMapV2Direction.java, I call the Google api and parse the xml. In devices below android 2.3 and more version device compatible.
