 ...
 * Model for Added reason activity
 */

@Table(name = "AddedDelayedReasonsModelActivity")
public class UpTimeAddedReasonsModelActivity extends Model {
    ...
    public UpTimeAddedReasonsModelActivity()
    {
        super();
    }
    ...
    public String getDelayedReasonComment() {
        return delayedReasonComment;
    }

    public void setDelayedReasonComment(String delayedReasonComment) {
        this.delayedReasonComment = delayedReasonComment;
    }

    public String getInreasonUniqueId() {
        return inreasonUniqueId;
    }

    public void setInreasonUniqueId(String inreasonUniqueId) {
        this.inreasonUniqueId = inreasonUniqueId;
    }
}
